...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Salih Beyatlı.</h2>;
  const three = <h3 className="big-heading">I create something.</h3>;
  const four = (
    <>
      <p>
        ...
        and
          {' '}
        <a href="https://www.behance.net/salihbeyatli" target="_blank" rel="noreferrer">
          Behance
        </a>
        .
      </p>
